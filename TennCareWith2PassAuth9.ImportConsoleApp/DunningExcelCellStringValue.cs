...
{
    public class DunningExcelCellStringValue
    {
        public DunningExcelCellStringValue
        (
        ...
        public GetDunningExcelCellStringValueOutput GetExcelCellStringValue()
        {
            GetDunningExcelCellStringValueOutput returnOutput = new GetDunningExcelCellStringValueOutput();
