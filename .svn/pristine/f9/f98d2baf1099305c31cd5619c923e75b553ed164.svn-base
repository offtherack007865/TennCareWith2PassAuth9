...
{
    public class CollectionsExcelCellStringValue
    {
        public CollectionsExcelCellStringValue
        (
        ...
        public GetCollectionsExcelCellStringValueOutput GetExcelCellStringValue()
        {
            GetCollectionsExcelCellStringValueOutput returnOutput = new GetCollectionsExcelCellStringValueOutput();
