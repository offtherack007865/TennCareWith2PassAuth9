    ...
    public class MainOps
    {
        ...
        public MainOpsOutput MyMain()
        {
            ...
            qy_GetAllMonthlyEntriesLookedUpTodayOutput
                myqy_GetAllMonthlyEntriesLookedUpTodayOutput =
                    GetAllMonthlyEntriesLookedUpToday();
            if (!myqy_GetAllMonthlyEntriesLookedUpTodayOutput.IsOk)
            {
                returnOutput.IsOk = false;
                returnOutput.ErrorMessage =
                    myqy_GetAllMonthlyEntriesLookedUpTodayOutput.ErrorMessage;
                return returnOutput;
            }
            if (
                    myqy_GetAllMonthlyEntriesLookedUpTodayOutput
            ...
            dd_TruncateMonthlyEntriesYieldingEligInfoTodayOutput
                mydd_TruncateMonthlyEntriesYieldingEligInfoTodayOutput =
                    TruncateMonthlyEntriesYieldingEligInfoToday();
            if (!mydd_TruncateMonthlyEntriesYieldingEligInfoTodayOutput.IsOk)
            {
                returnOutput.IsOk = false;
                returnOutput.ErrorMessage =
                    mydd_TruncateMonthlyEntriesYieldingEligInfoTodayOutput.ErrorMessage;
                return returnOutput;
            }
            ...
            for (int entryCtr = 0; entryCtr < myqy_GetAllMonthlyEntriesLookedUpTodayOutput.qy_GetAllMonthlyEntriesLookedUpTodayOutputColumnsList.Count; entryCtr++)
            {
                qy_GetAllMonthlyEntriesLookedUpTodayOutputColumns
                    loopEntry =
                        myqy_GetAllMonthlyEntriesLookedUpTodayOutput
                        .qy_GetAllMonthlyEntriesLookedUpTodayOutputColumnsList[entryCtr];
                int oneBasedEntryCtr = entryCtr + 1;
                Console.WriteLine($"Monthly Patient Appt {oneBasedEntryCtr} of {myqy_GetAllMonthlyEntriesLookedUpTodayOutput.qy_GetAllMonthlyEntriesLookedUpTodayOutputColumnsList.Count} being looked up.");
                ...
                du_MarkMonthlyEntryLookedUpTodayAsLookedUpOutput
                    mydu_MarkMonthlyEntryLookedUpTodayAsLookedUpOutput =
                        MarkMonthlyEntryLookedUpTodayAsLookedUp
                        (
                            loopEntry.MonthlyEntriesLookedUpTodayID
                        );
                if (!mydu_MarkMonthlyEntryLookedUpTodayAsLookedUpOutput.IsOk)
                {
                    returnOutput.IsOk = false;
                    returnOutput.ErrorMessage =
                        mydu_MarkMonthlyEntryLookedUpTodayAsLookedUpOutput.ErrorMessage;
                    return returnOutput;
                }
                ...
                di_InsertMonthlyEntriesYieldingEligInfoTodayOutput
                    mydi_InsertMonthlyEntriesYieldingEligInfoTodayOutput =
                        InsertMonthlyEntriesYieldingEligInfoToday
                        (
                            myFirefoxOps.MyFirefoxEligInfoForPatient
                        );
                if (!mydi_InsertMonthlyEntriesYieldingEligInfoTodayOutput.IsOk)
                {
                    returnOutput.IsOk = false;
                    returnOutput.ErrorMessage =
                        mydi_InsertMonthlyEntriesYieldingEligInfoTodayOutput.ErrorMessage;
                    return returnOutput;
                }
            }
            ...
            qy_GetMonthlyEntriesYieldingEligInfoTodayOutput
                myqy_GetMonthlyEntriesYieldingEligInfoTodayOutput =
                    qy_GetMonthlyEntriesYieldingEligInfoToday();
            if (!myqy_GetMonthlyEntriesYieldingEligInfoTodayOutput.IsOk)
            {
                returnOutput.IsOk = false;
                returnOutput.ErrorMessage =
                    myqy_GetMonthlyEntriesYieldingEligInfoTodayOutput
            ...
            if (myqy_GetMonthlyEntriesYieldingEligInfoTodayOutput
                ...
                .Count > 0)
            {
                ...
                string outputFilename =
                    myqy_GetMonthlyEntriesYieldingEligInfoTodayOutput
                    .qy_GetMonthlyEntriesYieldingEligInfoTodayOutputColumnsList[0]
                    .OutputFileName;

                returnOutput.MailBodyLineList.Add
                (
                    $"Created Output File:  {outputFilename} with {myqy_GetMonthlyEntriesYieldingEligInfoTodayOutput.qy_GetMonthlyEntriesYieldingEligInfoTodayOutputColumnsList.Count} Monthly Patient Eligibility Entry(ies)."
                );
            }
        ...
        public void CreateOutputFile
            (
                List<qy_GetMonthlyEntriesYieldingEligInfoTodayOutputColumns>
                    inputqy_GetMonthlyEntriesYieldingEligInfoTodayOutputColumnsList
            )
        {
            if (inputqy_GetMonthlyEntriesYieldingEligInfoTodayOutputColumnsList.Count == 0)
            {
                return;
            }
            ...
            foreach (qy_GetMonthlyEntriesYieldingEligInfoTodayOutputColumns loopEntry in inputqy_GetMonthlyEntriesYieldingEligInfoTodayOutputColumnsList)
            {
        ...
        public qy_GetMonthlyEntriesYieldingEligInfoTodayOutput qy_GetMonthlyEntriesYieldingEligInfoToday()
        {
            qy_GetMonthlyEntriesYieldingEligInfoTodayOutput returnOutput =
        ...
        public qy_GetAllMonthlyEntriesLookedUpTodayOutput GetAllMonthlyEntriesLookedUpToday()
        {
            qy_GetAllMonthlyEntriesLookedUpTodayOutput returnOutput =
        ...
        public du_MarkMonthlyEntryLookedUpTodayAsLookedUpOutput MarkMonthlyEntryLookedUpTodayAsLookedUp(int inputMonthlyEntryID)
        {
            du_MarkMonthlyEntryLookedUpTodayAsLookedUpOutput returnOutput =
                new du_MarkMonthlyEntryLookedUpTodayAsLookedUpOutput();
            CallWebApiLandClass myCallWebApiLandClass =
                new CallWebApiLandClass(this.MyConfigOptions.BaseWebApiUrl);
            returnOutput =
                myCallWebApiLandClass
                .du_MarkMonthlyEntryLookedUpTodayAsLookedUp(inputMonthlyEntryID);
            if (!returnOutput.IsOk)
            {
                returnOutput.IsOk = false;
                returnOutput.ErrorMessage =
        ...
        public dd_TruncateMonthlyEntriesYieldingEligInfoTodayOutput TruncateMonthlyEntriesYieldingEligInfoToday()
        {
            dd_TruncateMonthlyEntriesYieldingEligInfoTodayOutput returnOutput =
